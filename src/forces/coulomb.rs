...
use crate::gpu::{GpuContext, ParticleBuffers};
...
impl Potential for CoulombState {
    ...
    fn compute(
        ...
        // CoulombState is always a JIT pair-force participant (see
        ...
        unreachable!("CoulombState is JIT-composed; compute() is never invoked")
    }
...
"#;
    ...
    PairForceFragment {
        ...
        // Coulomb has no per-type parameters; it ignores i_type / j_type.
