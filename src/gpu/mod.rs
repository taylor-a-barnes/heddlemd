...
pub use kernels::{
    ...
    andersen_resample, berendsen_compute_mu, c_rescale_compute_mu, combine_class_totals,
    ...
    sort_cells_by_particle_id, spme_spread_bin_scatter,
    spme_spread_gather_to_rho, spme_spread_scatter,
